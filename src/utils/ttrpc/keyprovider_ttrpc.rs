...
impl KeyProviderServiceClient {
    ...
    pub async fn wrap_key(&mut self, ctx: ttrpc::context::Context, req: &super::keyprovider::keyProviderKeyWrapProtocolInput) -> ::ttrpc::Result<super::keyprovider::keyProviderKeyWrapProtocolOutput> {
    ...
    pub async fn un_wrap_key(&mut self, ctx: ttrpc::context::Context, req: &super::keyprovider::keyProviderKeyWrapProtocolInput) -> ::ttrpc::Result<super::keyprovider::keyProviderKeyWrapProtocolOutput> {
        let mut cres = super::keyprovider::keyProviderKeyWrapProtocolOutput::new();
